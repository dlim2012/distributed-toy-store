...
def orderstub_leader_selection(order_stubs):
    """
    This function will select the leader of the order components
    """
...
# reduced 21.4% in time consumption when connected through wireless connections
cache = dict()
